...
These docs are the source of truth for product behavior, architecture direction, and prototype notes.

## Current Focus

- Mobile-first guide player.
- Reusable puzzle visualization and animation.
- Unity-free puzzle model.
- Authored tutorials with structured guide blocks and visual actions.
